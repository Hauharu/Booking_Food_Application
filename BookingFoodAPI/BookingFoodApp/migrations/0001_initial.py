# Generated by Django 5.1.5 on 2025-01-25 05:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('available', 'Còn đồ ăn'), ('out_of_stock', 'Hết đồ ăn')], default='out_of_stock', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subscribers', to='BookingFoodApp.store')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='comments', to='BookingFoodApp.store')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
